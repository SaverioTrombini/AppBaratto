...
private final ControllerGraspUtente controllerGraspUtente;
	...
	public List<Articolo> getArticoliCategoria(String radice, String nomeCategoria, boolean admin) {
        return articoli.values().stream()
                .filter(article -> article.getCategoria().equals(controllerGraspCategoria.searchByName(radice, nomeCategoria)))
	 ...
	 public void addArticle(String username, String radice, String nomeCategoria, 
    		StatoArticolo stato, Map<String, String> descCampi) {

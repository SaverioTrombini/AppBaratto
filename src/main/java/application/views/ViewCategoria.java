...
public class ViewCategoria {
	public final static String[] MENU_CONFIGURATORE={"Aggiungi nuova categoria","Aggiungi nuova sotto categoria ad "
			+ "una categoria esistente","Visualizza gerarchia","Importa categorie in modalita batch"};
	...
	public void stampaSpiegazioneVisualizzazioneGerarchia() {
		System.out.println("i figli vengono mostrati sotto ai padri con un tab di indentazione");
    	System.out.println("NOME - {descrizione= obbligo,*}");		
	}
